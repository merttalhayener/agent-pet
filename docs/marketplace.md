...
Upload `artifacts/agent-pet-marketplace-0.11.0-darwin-arm64.vsix`. It contains the native helper, MIT license, icon, README and changelog. It is marked as a prerelease and targets Apple Silicon macOS.
