...
Version 0.11.0 is live at https://marketplace.visualstudio.com/items?itemName=merttalhayener.agent-pet. Version 0.11.4 is ready for upload. For subsequent releases, use the existing extension’s **Update** action, not New extension.
...
Upload `artifacts/agent-pet-marketplace-0.11.4-darwin-arm64.vsix`. It contains the native helper, MIT license, icon, README and changelog. It is marked as a prerelease and targets Apple Silicon macOS.
